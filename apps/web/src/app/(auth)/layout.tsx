...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="landing-page min-h-screen relative overflow-hidden flex flex-col lg:flex-row bg-white">
            ...
            <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-16 relative bg-[#05050a]">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-4">
                        <img src="/logo.png" alt="Synora Logo" className="h-72 w-72 object-contain invert brightness-0" />
                    </div>
                </div>
                ...
                <div className="relative z-10 space-y-10">
                    ...
                    <div className="grid grid-cols-2 gap-px bg-white/5 max-w-sm mt-10 border border-white/5 overflow-hidden">
                        {[
                ...
                <p className="relative z-10 font-mono-dm text-[10px] uppercase tracking-[0.2em] font-black text-white/20">
                    © 2026 SYNORA HEALTHTECH. CLINICAL GRADE IOT.
                </p>
            </div>

            {/* Right panel — Auth Form */}
            <div className="flex flex-1 items-center justify-center p-8 lg:p-20 bg-white relative">
